...
CREATE TABLE form_submissions (
  ...
  created_at TEXT NOT NULL DEFAULT (datetime('now'))
, idempotency_key TEXT, tracked_link_id TEXT, delivery_status TEXT NOT NULL DEFAULT 'pending'
  CHECK (delivery_status IN ('pending', 'sent', 'failed', 'not_required')), delivery_retry_key TEXT, delivery_error TEXT, delivery_attempts INTEGER NOT NULL DEFAULT 0);
