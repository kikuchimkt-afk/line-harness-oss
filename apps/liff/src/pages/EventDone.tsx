...
export default function EventDone() {
  ...
  const title = isWaitlisted ? 'キャンセル待ちを受け付けました' : isPending ? '受付しました' : '予約が確定しました';
  const desc = isWaitlisted
    ? '空席が出て本予約へ繰り上がると、LINEでお知らせします。現在の順番は予約履歴から確認できます。'
    : isPending
  ...
  return (
    <div className="p-8 text-center">
      <div className="text-5xl mb-4">{isPending || isWaitlisted ? '⏳' : '✅'}</div>
